...
from app.utils.external_api import get_currency_exchenge, get_currency_list, get_currencies_from_json
...
@router.get("/exchange", description="Convert currencies", dependencies=[Depends(security.access_token_required)])
...
@router.get("/list", description="Get currencies and update currency_list.json", dependencies=[Depends(security.access_token_required)])
